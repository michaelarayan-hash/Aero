...
async def _square_mission(drone):
    ...
    moves = [
    ("Go North",              VelocityNedYaw( 2.5,  0.0, 0, 0)),
    ("Hover",                 VelocityNedYaw( 0.0,  0.0, 0, 0)),   # pause
    ("Moving East",           VelocityNedYaw( 0.0,  2.5, 0, 90)),
    ("Hover",                 VelocityNedYaw( 0.0,  0.0, 0, 0)),   # pause
    ("Moving South",          VelocityNedYaw(-2.5,  0.0, 0, 180)),
    ("Hover",                 VelocityNedYaw( 0.0,  0.0, 0, 0)),   # pause
    ("Moving West to start",  VelocityNedYaw( 0.0, -2.5, 0, 270)),
    ("Hover",                 VelocityNedYaw( 0.0,  0.0, 0, 0)),   # pause
    ]

    for label, velocity in moves:
        print(f"-- {label}")
